...
describe('reject()', () => {
  ...
  it('rejects null values from an array', () => {
    const array = [2, 'old', 5, 'McDonald', 'had', 8, null, 11];
    expect(_.reject(array, values => values === null)).toEqual([2, 'old', 5, 'McDonald', 'had', 8, 11]);
  });
});